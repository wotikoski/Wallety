        ...
        right={
          <>
            <select
              ...
              className="text-[13px] font-semibold border-[1.5px] border-app-border rounded-[10px] px-3 h-[38px] bg-[var(--surface-raised)] text-app-text focus:outline-none focus:ring-2 focus:ring-[#3b82f6]"
            >
