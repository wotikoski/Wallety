        ...
        <div className="bg-white rounded-[14px] border border-app-border shadow-card p-5">
          {selectedDay ? (
            <>
              ...
              <p className="text-xs text-[#B0BAC9] mb-4">{selectedTxns.length} lançamento(s)</p>
              {selectedTxns.length === 0 ? (
                <p className="text-sm text-[#B0BAC9]">Nenhum lançamento neste dia</p>
              ) : (
                  ...
                  {selectedTxns.map((t) => (
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        {t.notes && (
                          <p className="text-xs text-[#B0BAC9] truncate mt-0.5">{t.notes}</p>
                        )}
                        <span className={`text-xs ${t.projected ? "text-[#B0BAC9]" : t.isPaid ? "text-income" : "text-[#B0BAC9]"}`}>
            ...
            <div className="h-full flex items-center justify-center text-[#B0BAC9] text-sm py-12">
